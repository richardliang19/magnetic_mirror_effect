...
while analyze>0: 
    ...
    for i in range(10):
        ...
        if electronic[i].pos.x>50 and electronic[i].pos.x<150 and electronic[i].pos.y<75 and electronic[i].pos.y>-75:
            ...
            ws[f'F{correctline}'].value = 0.5*m*(electronic[i].v.x**2+electronic[i].v.y**2+electronic[i].v.z**2)
            wb.save("vpython_data.xlsx")
            correctline+=1
        else: 
            ...
            ws[f'L{incorrectline}'].value = 0.5*m*(electronic[i].v.x**2+electronic[i].v.y**2+electronic[i].v.z**2)
            wb.save("vpython_data.xlsx")
            incorrectline+=1
